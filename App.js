...
for (let i = 0; i < ad.length; i++) {
    ...
    <div
            ...
            <div class="p-6">
                <h3 class="text-slate-900 text-xl font-semibold">${ad[i]}</h3>
                <p class="mt-3 text-sm leading-relaxed text-[#939292]"><span class="">Müəllif:</span> <span  class="font-bold">${muellif[i]}</span> </p>
                <p class="mt-3 text-xl text-[#f44a4a] leading-relaxed font-bold">${qiymet[i]} </p>
